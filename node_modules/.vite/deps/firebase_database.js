import { $ as safeGet, A as Sha1, B as getDefaultEmulatorHostnameAndPort, C as LogLevel, D as Provider, E as ComponentContainer, F as contains, G as isMobileCordova, H as isAdmin, I as createMockUserToken, J as isValidFormat, K as isNodeSdk, L as deepCopy, M as assertionError, N as base64, O as Deferred, P as base64Encode, Q as querystring, R as deepEqual, T as Component, U as isCloudWorkstation, V as getModularInstance, W as isEmpty, X as map, Y as jsonEval, Z as pingServer, c as _getProvider, et as stringLength, f as _registerComponent, g as getApp, j as assert, n as SDK_VERSION, nt as stringify, q as isReactNative, rt as updateEmulatorBanner, tt as stringToByteArray, u as _isFirebaseServerApp, w as Logger, x as registerVersion, z as errorPrefix } from "./index.esm-DyNAL_Of.js";
	...
	*/
	...
	static warnOnListenWarnings_(payload, query$1) {
		if (payload && typeof payload === "object" && contains(payload, "w")) {
			...
			if (Array.isArray(warnings) && ~warnings.indexOf("no_index")) warn(`Using an unspecified index. Your data will be downloaded and filtered on the client. Consider adding ${"\".indexOn\": \"" + query$1._queryParams.getIndex().toString() + "\""} at ${query$1._path.toString()} to your security rules for better performance.`);
		}
	}
	refreshAuthToken(token) {
...
var PriorityIndex = class extends Index {
	...
	makePost(indexValue, name$1) {
		return new NamedNode(name$1, new LeafNode("[PRIORITY-POST]", nodeFromJSON$1(indexValue)));
	}
	/**
	* @returns String representation for inclusion in a query spec
	*/
...
var PathIndex = class extends Index {
	...
	makePost(indexValue, name$1) {
		...
		return new NamedNode(name$1, ChildrenNode.EMPTY_NODE.updateChild(this.indexPath_, valueNode));
	}
	maxPost() {
...
var ValueIndex = class extends Index {
	...
	makePost(indexValue, name$1) {
		return new NamedNode(name$1, nodeFromJSON(indexValue));
	}
	/**
	* @returns String representation for inclusion in a query spec
	*/
...
function viewProcessorApplyServerOverwrite(viewProcessor, oldViewCache, changePath, changedSnap, writesCache, completeCache, filterServerNode, accumulator) {
	...
	return viewProcessorGenerateEventCacheAfterServerEvent(viewProcessor, newViewCache$1, changePath, writesCache, new WriteTreeCompleteChildSource(writesCache, newViewCache$1, completeCache), accumulator);
}
function viewProcessorApplyUserOverwrite(viewProcessor, oldViewCache, changePath, changedSnap, writesCache, completeCache, accumulator) {
	...
	if (pathIsEmpty(changePath)) {
		...
		if (childKey === ".priority") {
			...
			if (!oldChild.equals(newChild)) newViewCache$1 = viewCacheUpdateEventSnap(oldViewCache, viewProcessor.filter.updateChild(oldEventSnap.getNode(), childKey, newChild, childChangePath, source, accumulator), oldEventSnap.isFullyInitialized(), viewProcessor.filter.filtersNodes());
...
function syncPointGetView(syncPoint, query$1, writesCache, serverCache, serverCacheComplete) {
	...
	if (!view) {
		...
		return new View(query$1, newViewCache(new CacheNode(eventCache, eventCacheComplete, false), new CacheNode(serverCache, serverCacheComplete, false)));
	}
	return view;
}
/**
...
function syncTreeGetServerValue(syncTree, query$1) {
	...
	return viewGetCompleteNode(syncPointGetView(syncPoint, query$1, writesCache, serverCacheComplete ? serverCacheNode.getNode() : ChildrenNode.EMPTY_NODE, serverCacheComplete));
}
/**
...
function syncTreeCreateListenerForView_(syncTree, view) {
	...
	return {
		...
		onComplete: (status) => {
			...
			else return syncTreeRemoveEventRegistration(syncTree, query$1, null, errorForServerCode(status, query$1));
		}
	};
}
/**
...
function push(parent, value) {
	...
	const name$1 = nextPushId(repoServerTime(parent._repo));
