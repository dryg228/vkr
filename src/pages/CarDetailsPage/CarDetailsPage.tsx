  ...
  return (
    <div className={styles.page}>
      ...
      <div className={styles.mainLayout}>
        ...
        {/* 1. ФОТОГРАФИЯ АВТОМОБИЛЯ (СВЕРХУ) */}
        ...
        {/* 3. ИНФОРМАЦИЯ О ВЛАДЕЛЬЦЕ И КНОПКА ЗАКАЗА */}
        <Card className={styles.bookingCard}>
          ...
          {/* Встроенный список забронированных периодов */}
          {bookedDates.length > 0 && (
            <div className={styles.bookedDatesCalendar}>
              <span className={styles.calendarTitle}>📅 Автомобиль забронирован:</span>
              <div className={styles.calendarList}>
                {bookedDates.map((period, idx) => (
                  ...
                  >
                    <span>{period.status === 'active' ? '🔴 В поездке:' : '🟡 Бронь:'}</span>
        ...
        {/* 4. ОТЗЫВЫ ВОДИТЕЛЕЙ (ТЕПЕРЬ ТОЧНО В САМОМ НИЗУ) */}
